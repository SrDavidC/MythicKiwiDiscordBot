    ...
    client.handleMusicEvents = async () => {
        ...
        client.distube
            .on('playSong', async (queue, song) => {
                ...
                const meta_message = await song.metadata.interaction.channel.send({
                    embeds: [embed],
                    components: [Buttons],
                });
                song.metadata = { interaction: song.interaction, channel: song.metadata.interaction.channel, message: meta_message}; 
